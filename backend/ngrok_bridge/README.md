...
- Streaming openai-whisper transcripts broadcast every few seconds (defaults 3 s/6 s/15 s) so the waveform shows “typing” updates while recording; final updates arrive when the 15 s segment seals
